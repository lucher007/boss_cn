/**
 * @(#)FormatHTMLLayout.java	1.00 2013-1-6
 *
 * 中江联合 2013，版权所有.
 */
 ...
 * <dl>
 * <dt>MES_10</dt>
 * <dd>Description: 将前台日志打印输入成HTML</dd>
...
//      sbuf.append("<td>&nbsp;???/td>");  
    ...
    private void appendThrowableAsHTML(final String[] s, final StringBuffer sbuf) {   
        if (s != null) {   
            int len = s.length;   
            if (len == 0)   
                return;   
    ...
    //  sbuf.append("<th>??</th>" + Layout.LINE_SEP);   
        ...
        sbuf.append("<th>Level</h>" + Layout.LINE_SEP);   
    //  sbuf.append("<th>??`</th>" + Layout.LINE_SEP);   
        if (locationInfo) {   
