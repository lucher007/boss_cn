...
<div id="body">
  ...
  <form method="post" id="addForm" name="addForm">
    ...
    <input type="hidden" name="userproductids" id="userproductids" value="${userbusiness.userproductids }"/>
...
<script type="text/javascript">
  ...
  function cancelBussiness() {
       ...
       $.dialog({
		    title: '<spring:message code="确定保存？"/>',
		    lock: true,
		    background: '#000', /* 背景色 */
		    opacity: 0.5,       /* 透明度 */
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#addForm").attr("action", "usergroup/cancelBusiness"+"?rid="+Math.random());
				$("#addForm").submit();
