...
<body>
	<div id="body">
	<div class="cur-pos"><spring:message code="page.currentlocation"/>：集团业务 &gt; <spring:message code="menu.business.userquery"/></div>
	<div class="easyui-panel" title="<spring:message code="user.userquery"/>" style="width:100%">
        <form action="" method="post" id="searchForm" name="searchForm">
			...
			<input type="hidden" name="queryusertype" id="queryusertype" value="1"/>
			<table width="100%">
				<tr height="30px">
...
<script type="text/javascript">
	...
	function initUserlist(){
		...
		//添加
		function addUser(){
			$("#searchForm").attr("action", "usergroup/addInit");
			$("#searchForm").submit();
		}	
		...
		*/
		function lookUserBusinessInfo(id){
			$("#searchForm").attr("action", "usergroup/lookUserBusinessInfo?id="+id);
			$("#searchForm").submit();
		}
		...
		*/
		function deleteUser(id){
			$.dialog.confirmMultiLanguage('<spring:message code="page.confirm.execution"/>?', 
				...
				function(){ 
					$("#searchForm").attr("action", "usergroup/delete?id="+id+"&pager_offset="+'${user.pager_offset}'+"&rid="+Math.random());
					$("#searchForm").submit();
				}, function(){
							});
		}
