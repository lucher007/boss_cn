...
<div class="userInfo">
    	...
    	<table>
          <tr class="fbc-tit">
            ...
            <td>
		         <input type="button" class="btn-back" value="<spring:message code="page.switch"/>" onclick="switchUserGroup('<spring:message code="menu.business.userquery"/>')" >
            </td>
          </tr>
          <tr>
...
<div class="transferUserInfo">
    	...
    	<table>
          ...
          <tr>
            <td width="10%" align="right" class="line-r"><spring:message code="user.address"/>：</td>
            <td width="15%" style="font-weight: bold;" class="line-r" colspan="3">${user.user.transferuser.address}</td>
          	<td width="10%" align="right" class="line-r"><spring:message code="订户级别"/>：</td>
            <td width="15%" style="font-weight: bold;" class="line-r" title="${user.user.transferuser.userlevel.levelname}">${fn:substring(user.user.transferuser.userlevel.levelname, 0, 70)}</td>
          	<td width="10%" align="right" class="line-r"><spring:message code="systempara.remark"/>：</td>
            <td width="15%" style="font-weight: bold;" class="line-r" title="${user.user.transferuser.remark}">${fn:substring(user.user.transferuser.remark, 0, 70)}</td>
          </tr>
        </table>
</div>
