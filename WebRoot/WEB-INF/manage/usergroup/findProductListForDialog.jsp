...
<body>
	<div id="body">
	<div class="cur-pos"><spring:message code="page.currentlocation"/>：<spring:message code="集团业务"/> &gt; <spring:message code="product.productquery"/></div>
    <div class="seh-box">
        <form action="" method="post" id="searchForm" name="searchForm">
        	<input type="hidden" name="cardids" id="cardids" value="${product.cardids}"/>
    ...
    <div class="page">
    	<cite>
        	<pg:pager
			    url="usergroup/findProductListForDialog"
				...
				<pg:param name="cardids" value="${product.cardids}"/>
    ...
    <div class="pop-box" id="pop-div">
			<table width="400" border="0" cellpadding="0" cellspacing="0">
	          ...
	          <tr>
	            ...
	            <td width="60%">
	            	<input type="text" id="endtime" name="endtime"  class="Wdate inp" 
...
<script type="text/javascript">
	...
	function queryProduct(){
		$("#searchForm").attr("action", "usergroup/findProductListForDialog");
		$("#searchForm").submit();
	}	
  ...
  $(".lb-list").click(function(){
    ...
    function addBuyingProduct(productid){
		...
		var url="usergroup/addBuyingProduct?rid="+Math.random();
		$.getJSON(url,data,function(jsonMsg){
			if(jsonMsg.flag=="0"){
