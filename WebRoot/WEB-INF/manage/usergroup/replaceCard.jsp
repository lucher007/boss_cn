...
<body>
<div id="body">
  <div class="cur-pos"><spring:message code="page.currentlocation"/>：集团业务 &gt; <spring:message code="menu.business.cardreplace"/></div>
	...
	$(function () {
	 ...
	 function selectCard() {
	    ...
	    if(rowsSelected == null  || rowsSelected == ''){
       	 $.dialog.tips('<spring:message code="请选择需要更换的旧智能卡信息"/>', 2, 'alert.gif');
		      return;
        }
