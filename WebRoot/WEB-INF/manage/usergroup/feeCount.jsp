...
<body>
<div id="body">
  <div class="cur-pos"><spring:message code="page.currentlocation"/>：<spring:message code="集团业务"/> &gt; <spring:message code="userbusiness.feecount"/></div>
...
<script type="text/javascript">
  ...
  function saveUser() {
  		...
  		if($("#paytype").val()=="1"){
  		 ...
  		 $("#addForm").attr("action", "usergroup/saveBusiness"+"?rid="+Math.random());
		$("#addForm").submit();
