...
<body>
<div id="body">
  <div class="cur-pos"><spring:message code="page.currentlocation"/>：<spring:message code="订户级别管理"/> &gt; <spring:message code="订户级别添加"/></div>
  <form method="post" id="addForm" name="addForm">
  	<input type="hidden" name="id" id="id" value="${userlevel.id}">
    <div class="form-box">
      <div class="fb-tit"><spring:message code="订户级别添加"/></div>
      <div class="fb-con">
