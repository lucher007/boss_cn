...
<body>
	<div class="form-box">
	  <form method="post" id="paramForm" name="paramForm">
	    <div class="cur-pos"><spring:message code="page.currentlocation" />：<spring:message code="menu.authorize.manage" />&gt;<spring:message code="menu.authorize.resetpincode"/></div>
	    <div class="fb-con">
	      <div class="cur-pos">
	      ...
	      <div id="info">
	      	<iframe id="resetpincode" scrolling="auto" frameborder="0" style="width:100%;height:580px;"></iframe>
	      </div>
	       </form>
	    </div>
	    <!--
	...
	<script type="text/javascript">
		...
		function goBack(){
			$("#paramForm").attr("action", "cascommand/find_resetpincode_List");
			$("#paramForm").submit();
		}
		...
		function changeVersiontype() {
		    $("#resetpincode").attr("src","<%=request.getContextPath()%>/cascommand/add_resetpincode_Info?versiontype=" + $('#versiontype').val());
		}
