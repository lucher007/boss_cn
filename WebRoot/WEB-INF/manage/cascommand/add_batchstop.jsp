...
<body>
	<div id="body">
		<div class="cur-pos"><spring:message code="page.currentlocation" />：<spring:message code="menu.authorize.manage" />&gt;<spring:message code="menu.authorize.batchstop"/></div>
...
// 		}
		...
		$.dialog({
		    title: '<spring:message code="menu.authorize.batchstop"/>',
		    lock: true,
		    background: '#000', /* 背景色 */
		    opacity: 0.5,       /* 透明度 */
		    ...
		    icon: 'alert.gif',
		    ok: function () {
		    	$("#sendForm").attr("action", "cascommand/send_batchstop"+"?rid="+Math.random());
				$("#sendForm").submit();
		...
		//$("#sendForm").attr("action", "cascommand/send_batchstop").submit();
	}
