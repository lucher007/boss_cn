    	...
    	<table id="treetable" class="treetable"  width="100%" border="0" cellspacing="0" cellpadding="0">
        	...
        	<c:forEach items="${user.userlist }" var="dataList">
	        	<tr height="30"class="lb-list">
	        		...
	        		<td ><spring:message code="user.state.${dataList.state}"/></td>
...
<script type="text/javascript">
	...
	*/
	function lookUserBusinessInfo(id){
		$("#searchForm",window.parent.document).attr("action", "user/lookUserBusinessInfo?id="+id+"&pager_offset="+'${user.pager_offset}');
