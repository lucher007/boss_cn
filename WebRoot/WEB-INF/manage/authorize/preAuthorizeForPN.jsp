...
<body>
	<div id="body">
		<div class="seh-box">
			<form action="" method="post" id="searchForm" name="searchForm">
				...
				<div class="page">
					<cite> <pg:pager url="authorize/preAuthorizeForPN" items="${authorizeParamForPages.product.pager_count}" index="center" maxPageItems="10"
	...
	<script type="text/javascript">
		...
		function queryProduct() {
			$("#searchForm").attr("action", "authorize/preAuthorizeForPN");
			$("#searchForm").submit();
		}
		...
		function preAuth() {
			...
			$("#searchForm").attr("action", "authorize/savePreAuthorizeForPN");
			$("#searchForm").submit();
		}
