...
<body>
<div id="body">
	<div class="cur-pos"><spring:message code="page.currentlocation"/>：<spring:message code="menu.authorize.authorizerefresh"/>  &gt; <spring:message code="server.versiontype.gos_pn"/></div>
    <div class="seh-box">
        <form action="" method="post" id="searchForm" name="searchForm">
				<table width="100%">
					<tr>
						<td align="right" width="120px">用户编号：</td>
						<td><input type="text" class="inp w200"  name="queryusercode" id="queryusercode" value="${authorizehistory.queryusercode}"></td>										
						<td align="right">用户卡号：</td>
						<td><input type="text" class="inp w200"  name="querycardid" id="querycardid" value="${authorizehistory.querycardid}"></td>										
						<td><input type="button" class="btn-sch" value="搜索" onclick="queryHistory();" /></td>
					</tr>
					<tr>
			    ...
			    <div class="lst-box">
			    	<table id="treetable" class="treetable"  width="100%" border="0" cellspacing="0" cellpadding="0">
			        	...
			        	<c:forEach items="${authorizehistory.authorizehistorylist }" var="dataList">
			    ...
			    <div class="page">
			    	<cite>
			        	<pg:pager
						    url="authorize/authorityRenewForPN"
							...
							<%-- 
							<pg:param name="querynetid" value="${authorize.querynetid}"/>
...
<script type="text/javascript">
	...
	function queryHistory(){
		$("#searchForm").attr("action", "authorize/authorityRenewForPN");
		$("#searchForm").submit();
	}	
