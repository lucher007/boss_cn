...
<div id="body">
  ...
  <form action="" method="post" id="updateform" name="updateform">
    ...
    <input type="hidden" name="definedflag" id="definedflag" value="${businesstype.businesstype.definedflag}"/>
      ...
      <div class="fb-con">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="25%">
              <c:choose>
              	<c:when test="${businesstype.businesstype.definedflag == '0'}">
              		<input type="text" class="inp" name="typekey" id="typekey" value="${businesstype.businesstype.typekey }" readonly="readonly" style="background:#eeeeee;">
              	</c:when>
              	<c:otherwise>
              		<input type="text" class="inp" name="typekey" id="typekey" value="${businesstype.businesstype.typekey }">
              	</c:otherwise>
              </c:choose>
          ...
          <tr>
            ...
            <td>
            	<c:choose>
	              	<c:when test="${businesstype.businesstype.definedflag == '0'}">
	              		<input type="text" class="inp" name="typename" id="typename" value="<spring:message code="business.type.${businesstype.businesstype.typekey}"/>" readonly="readonly" style="background:#eeeeee;">
	              	</c:when>
	              	<c:otherwise>
	              		<input type="text" class="inp" name="typename" id="typename" value="${businesstype.businesstype.typename }">
	              	</c:otherwise>
              	 </c:choose>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td >
              <input type="text" name="price" id="price" value="${businesstype.businesstype.price }" class="easyui-numberbox" data-options="precision:2" maxlength="10">
            </td>
          </tr>
           ...
           <tr>
            ...
            <td>
              <input type="text" class="inp" name="feename" id="feename" value="${businesstype.businesstype.feename}">
            </td>
          </tr>
        </table>
      </div>
