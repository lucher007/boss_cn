...
<body>
	<div id="body">
		...
		<div class="lst-box">
			<table id="treetable" class="treetable" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr class="lb-tit">
					...
					<td><spring:message code="authorize.channelids"/></td>
		...
		<div class="page">
			<cite><pg:pager url="cas_pn/find_Cmd60_List" items="${caspnnewfinger.pager_count}" index="center" maxPageItems="10"
	...
	<script type="text/javascript">
		...
		function deleteById(id){
			...
			$.dialog.confirmMultiLanguage(
					...
					'<spring:message code="page.cancel"/>', function() {
						$("#searchForm").attr(
								"action",
								"cas_pn/send_cancel_Cmd60?id=" + id 
										+ "&pager_offset="
										+ '${caspnnewfinger.pager_offset}'
										+ "&rid=" + Math.random());
						$("#searchForm").submit();
		...
		function query() {
			$("#searchForm").attr("action", "cas_pn/find_Cmd60_List");
			$("#searchForm").submit();
		}

		function add() {
			$("#searchForm").attr("action", "cas_pn/add_Cmd60_Init");
			$("#searchForm").submit();
		}
