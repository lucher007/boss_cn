...
<body>
	<div id="body">
		<div class="cur-pos"><spring:message code="page.currentlocation" />：<spring:message code="menu.authorize.manage" />&gt;<spring:message code="menu.authorize.blackstb" />(<spring:message code="server.versiontype.gos_pn" />)</div>
		<div class="seh-box">
			<form action="" method="post" id="searchForm" name="searchForm">
				<table width="100%">
						...
						<tr>
							  ...
							  <td><input type="text" id="querydate" name="querydate" value="${caspnblackstb.querydate}" onfocus="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowWeek:true,isShowClear:true,dateFmt:'yyyy-MM-dd'});" class="Wdate inp w150" /></td>
		...
		<div class="page">
			<cite><pg:pager url="cas_pn/find_Cmd46_List" items="${caspnblackstb.pager_count}" index="center" maxPageItems="10"
	...
	<script type="text/javascript">
		...
		function deleteById(id){
			...
			$.dialog.confirmMultiLanguage(
					...
					'<spring:message code="page.cancel"/>', function() {
						$("#searchForm").attr(
								"action",
								"cas_pn/send_cancel_Cmd46?id=" + id 
										+ "&pager_offset="
										+ '${caspnblackstb.pager_offset}'
										+ "&rid=" + Math.random());
						$("#searchForm").submit();
		...
		function query() {
			$("#searchForm").attr("action", "cas_pn/find_Cmd46_List");
			$("#searchForm").submit();
		}

		function add() {
			$("#searchForm").attr("action", "cas_pn/add_Cmd46_Init");
			$("#searchForm").submit();
		}
