...
<body>
	<div id="body">
		<div class="cur-pos"><spring:message code="page.currentlocation" />：<spring:message code="menu.authorize.manage" /> &gt; <spring:message code="menu.authorize.resetpincode"/>(普安)</div>
	...
	function cardid_optionInit() {
		...
		function goSend() {
			...
			$("#paramForm").attr("action", "cas_pn/send_Cmd03");
			$("#paramForm").submit();
		}
