    ...
    <div class="lst-box">
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <c:forEach items="${operator.operatorlist}" var="dataList" varStatus="vs">
	          <tr class="lb-list">
				<td height="30">${dataList.operatorname }&nbsp;</td>
				<td>${dataList.operatorcode }&nbsp;</td>
				<td>${dataList.mobile}&nbsp;</td>
	           	<td><a href="javascript:operatorReport(${dataList.id },'${dataList.operatorname }');" ><spring:message code="statistic.report" /></a></td>
	          </tr>
          </c:forEach>
        </table>
...
<script type="text/javascript" src="js/plugin/lhgdialog/lhgdialog.js?skin=iblue&self=true"></script>
<script type="text/javascript">

	function queryOperator(){
		$("#searchForm").attr("action", "statistic/findOperatorList?jumping=findOperatorListForReport");
		$("#searchForm").submit();
	}	
    ...
    var operatorReportForDialog;
	 function operatorReport(operatorid, operatorname) {
	    	operatorReportForDialog = $.dialog({
		    	title: '<spring:message code="statistic.servicereport" />('+operatorname+')',
		    	lock: true,
		    	width: 900,
		    	height: 530,
		    	top: 0,
		    	...
		    	max: false,
		    	min: false,
		    	content: 'url:statistic/operatorReportForDialog?operatorid='+operatorid+'&operatorname='+operatorname+"&rid="+Math.random()
				});
	 }
</script>
</body>
