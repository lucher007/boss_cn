...
/* input.btn-export{ 
width:100px; 
height:21px; line-height:25px; margin-top:10px; 
cursor:pointer; border:0; 
background:url(../images/frame/btn-sch.png); 
...
<div id="body">
    <div class="seh-box">
        <form action="" method="post" id="searchForm" name="searchForm">
       		  <input type="hidden" id="storeid" name="storeid" value="${businessReport.storeid}" />
		       <table width="100%">
						<tr>
								<td align="right"><spring:message code="statistic.querytime.range" />：</td>
								<td>
									<select style="width: 120px;" id="querydatetype" name="querydatetype" class="select" onChange="queryDateType()">
								...
								<td>
			                 		 <input style="width: 120px;" value="${businessReport.queryyear}" type="text" id="queryyear" name="queryyear" readonly="readonly" onclick="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowWeek:true,isShowClear:true,dateFmt:'yyyy'});" class="Wdate inp w150" />
								     <input style="width: 120px;" value="${businessReport.querymonth}" type="text" id="querymonth" name="querymonth" readonly="readonly" onclick="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowClear:true,dateFmt:'yyyy-MM'});" class="Wdate inp w150" />
								     <input style="width: 120px;" value="${businessReport.queryday}" type="text" id="queryday" name="queryday" readonly="readonly" onclick="WdatePicker({lang:'${locale}',skin:'blueFresh',isShowWeek:true,isShowClear:true,dateFmt:'yyyy-MM-dd'});" class="Wdate inp w150" />
								</td>
					    		...
					    		<td>
					    			<input type="button" class="btn-export" value="<spring:message code="statistic.exportexcel"/>" onclick="saveDownloadEventFile();"/>
...
<script type="text/javascript">
	...
	function saveDownloadEventFile(){
		$("#searchForm").attr("action", "statistic/findExportStoreReportExcel");
		$("#searchForm").submit();
	}
	
	function queryDate(){
	$("#searchForm").attr("action", "statistic/storeReportForDialog");
		$("#searchForm").submit();
	}
